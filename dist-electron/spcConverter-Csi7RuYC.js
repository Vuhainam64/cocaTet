...
import require$$0$7 from "node:zlib";
...
import { g as getAugmentedNamespace } from "./_commonjsHelpers-BhWcALO8.js";
var undici = { exports: {} };
var symbols;
...
async function convertSPC(entries, proxyId = null) {
  const { getDatabase } = await import("./index-B4ntsY6U.js").then((n) => n.i);
  const { ProxyModel } = await import("./proxy-BFfub94j.js");
  getDatabase();
